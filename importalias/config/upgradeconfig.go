...
import (
	...
	"github.com/palantir/godel-okgo-asset-importalias/importalias/config/internal/legacy"
	v0 "github.com/palantir/godel-okgo-asset-importalias/importalias/config/internal/v0"
)
