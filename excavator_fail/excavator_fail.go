...
Output:
Error: failed to resolve 2 plugin(s):
    failed to resolve artifact com.palantir.godel-amalgomate-plugin:amalgomate-plugin:1.55.0 using resolvers:
    failed to resolve artifact at https://github.com/palantir/godel-amalgomate-plugin/releases/download/v1.55.0/amalgomate-plugin-1.55.0-linux-amd64.tgz: request for URL https://github.com/palantir/godel-amalgomate-plugin/releases/download/v1.55.0/amalgomate-plugin-1.55.0-linux-amd64.tgz returned status code 404
